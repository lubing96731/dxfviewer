...
class Ellipse : public Entity {
 public:
  Ellipse(const Point &center, const Point &majorPos, double ratio,
 ...
 private:
  ...
  double m_eStartAngle; //椭圆起始角
  double m_eEndAngle;   //椭圆结束角
 ...
 public:
  ...
  int GetDrawFlag() const { return m_drawFlag; }

  double GetA() const { return m_a; }
  double GetB() const { return m_b; }
  const std::vector<Point *> &GetRotaEllipsePts() const {
    return m_rotaEllipsePts;
  }
